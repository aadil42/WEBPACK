...
module.exports = {
    ...
    mode: 'development', // it can be set to development, production, and none mode. the production mode will display more debuggable error in-contrast to production mode 
    module: {
        rules: [
            {
                test: /\.(png|jpg)$/,
            ...
            { 
                ...
                use:  [ // you put loaders inside 'use' array.
                    'style-loader', 'css-loader'// you need to install these loader with npm. if you don't understand this, go to https://webpack.js.org/loaders/style-loader/ . btw the order of the loaders is important.
                ]
            },
            { 
                test: /\.scss$/,
                use:  [
                    'style-loader', 'css-loader', 'sass-loader' // the order of loaders matter 
                ]
            },
            { 
                test: /\.js$/,
